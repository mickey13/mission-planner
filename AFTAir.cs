...
namespace MissionPlanner
{
    public partial class AFTAir : Form
    {
                    ...
                    try
                    {
                        ...
                        for (int a = 0; a < (count); a++)
                        {
                            ...
                            try
                            {
                                ...
                                aftAir._updatePolygonBoundary(pll);
        ...
        private void AFTAir_Load(object sender, EventArgs e)
        {
            ...
            // Set firmware
            comPort.MAV.cs.firmware = Firmwares.ArduCopter2;
        }
        ...
        {
            var mapIdx = aftAir.Controls.GetChildIndex(elementHost1);
            var vidIdx = aftAir.Controls.GetChildIndex(picVidDownlink);
            ...
            if (mapIdx < vidIdx)
            {
                ...
                aftAir.Controls.SetChildIndex(picVidDownlink, mapIdx);
            ...
            else
            {
                ...
                aftAir.Controls.SetChildIndex(elementHost1, vidIdx);
                elementHost1.Dock = DockStyle.Fill;
        ...
        protected override void OnClosing(CancelEventArgs e)
        {
            ...
            Console.WriteLine("AFTAir_FormClosing done");
