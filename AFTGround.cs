...
namespace MissionPlanner
{
    public partial class AFTGround : Form
    {
        ...
        /// <summary>
        /// Connect to drone with ground interface
        /// </summary>
                            ...
                            AFTController.comPort.MAV.aptype != MAVLink.MAV_TYPE.GIMBAL)
                        {
                            System.Threading.ThreadPool.QueueUserWorkItem(state =>
                            {
                                ...
                                try
                                {
                                    ...
                                    if (aftGround != null && newPolygon.Locations.Count > 0 &&
        ...
        void _updatePolygonBoundary(Location locationToBeAdded)
        {
            ...
            // This should be changing the pushpin anchor point to the bottom center of the pushpin (the pushpin point),
            // but it does not work
            //polygonPushPin.PositionOrigin = PositionOrigin.BottomCenter;
